...
import com.example.myapparel.View.BrowseApparel.BrowseApparelActivity
...
@Composable
fun IconCard( icon : HomeScreenIconsClass){
    ...
    Card(
        ...
        onClick = {
            when(icon.changeTo){
                "ADD" -> context.startActivity(Intent(context, AddApparelActivity::class.java))
                "BROWSE" -> context.startActivity(Intent(context, BrowseApparelActivity::class.java))
            }
